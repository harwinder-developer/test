...
$data_image = sanitize_title_with_dashes( $field[ 'key' ] );

?>
<div id="charitable_field_<?php echo $field[ 'key' ] ?>" class="pp-charitable-picture <?php echo $classes ?>">    
    ...
    <div id="<?php echo $field[ 'key' ] ?>-dragdrop" 
        ...
        data-images="<?php echo $data_image; ?>-dragdrop-images"
        ...
        <div id="<?php echo $field[ 'key' ] ?>-dragdrop-dropzone" class="charitable-drag-drop-dropzone" <?php if ( $has_max_uploads ) : ?>style="display:none;"<?php endif ?>>
            <a id="<?php echo $field['key'] ?>-browse-button" class="pp-picture-placeholder" href="javascript:;">
				<i class="fa fa-plus"></i>
				<?php _e('ADD PHOTO', 'philantghropy'); ?>
			</a>
        </div>
        ...
        <ul id="<?php echo $data_image; ?>-dragdrop-images" class="charitable-drag-drop-images charitable-drag-drop-images-<?php echo $max_uploads ?>"><?php 
            foreach ( $value as $image ) : 
            
                pp_toolkit_template( 'form-fields/picture-preview.php', array( 'image' => $image, 'field' => $field ) );
