...
$tickets_details = $report->get_tickets();

$currency_helper = charitable_get_currency_helper();

$total_donation = array_sum( wp_list_pluck( $tickets_details, 'amount' ) );

// echo "<pre>";
// print_r($tickets_details);
// echo "</pre>";
				...
				<div class="uk-grid">
					...
					<div class="uk-width-1-1 uk-width-medium-1-3">
						<div class="block-amount">
						  	...
						  	<div class="inner">
						  		<?php $sum = array_sum(wp_list_pluck( $tickets_details, 'quantity' )); ?>
			        ...
			        <table class="report-table table-tickets">
			            ...
			            foreach ( $tickets_details as $ticket ) : 
			                ...
			                <tr class="<?php echo $tr_classes; ?>">
			                    <td class="qty"><?php echo $ticket->quantity; ?></td>
			                    <td class=""><?php echo $ticket->name; ?></td>
			                </tr>
