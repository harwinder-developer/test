...
<script id="report-campaigns-template" type="text/x-handlebars-template">
				...
				<div class="uk-grid">
					...
					<div class="uk-width-1-1 uk-width-medium-1-3">
						<div class="block-amount">
						  	...
						  	<div class="inner">
						  		<div class="amount"><?php echo charitable_get_table( 'campaign_donations' )->count_campaign_donors( $report->get_campaign_ids(), false ); ?></div>
								<div class="sub">Supporters</div>
						  	</div>
						</div>
					</div>
				</div>
