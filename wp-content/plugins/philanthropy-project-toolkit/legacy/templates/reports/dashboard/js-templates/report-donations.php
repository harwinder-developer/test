...
<script id="report-donations-template" type="text/x-handlebars-template">
			...
			<div class="uk-width-1-1 uk-width-medium-3-5">
				<div class="container-donation load-more-table-container">
			        <table class="report-table table-donation">
			        	<thead>
							<tr>
								<td class="thead-amount">AMOUNT</td>
								<td>DONOR NAME</td>
								<td class="thead-campaign-name">CAMPAIGN NAME</td>
							</tr>
						</thead>
			            <tbody>
			            	{{#each data}}
							...
							<tr class="{{#ifMoreThan 5 @index}}more{{/ifMoreThan}}">
			                    ...
			                    <td class="link">{{first_name}} {{last_name}}</td>
