<?php
/**
 * A helper class to retrieve Merchandise Donations.
 */

// Exit if accessed directly.
if ( ! defined( 'ABSPATH' ) ) { exit; }

if ( ! class_exists( 'PP_Merchandise_Donations_Query' ) ) :

	/**
	 * PP_Merchandise_Donations_Query
	 *
	 * @since 	1.4.0
	 */
	class PP_Merchandise_Donations_Query extends Charitable_Query {
		...
		public function get_donations() {
			...
			$cache_key = 'merchandise-donations' . md5( maybe_serialize( $this->args ) );
