        ...
        <?php if ( $has_links ) : ?>
            <ul class="creator-links">
                <?php if ( $creator->user_url ) : ?>
                    <li>
                        <a href="<?php echo $creator->user_url ?>" title="<?php printf( __( "Visit %s's website", 'charitable-ambassadors' ), $creator->get_name() ) ?>" target="_blank"><i class="fa fa-globe"></i> <?php _e( 'Website', 'charitable-ambassadors' ) ?></a>
                    </li>
                <?php endif ?>
                <?php if ( $creator->twitter ) : ?>
                    <li>
                        <a href="<?php echo $creator->twitter ?>" title="<?php printf( __("Visit %s's Twitter profile", 'charitable-ambassadors'), $creator->get_name() ) ?>" target="_blank"><i class="fa fa-twitter"></i> <?php _e( 'Twitter', 'charitable-ambassadors' ) ?></a>
                    </li>
                <?php endif ?>

                <?php if ( $creator->facebook ) : ?>
                    <li>
                        <a href="<?php echo $creator->facebook ?>" title="<?php printf( __("Visit %s's Facebook profile", 'charitable-ambassadors'), $creator->get_name() ) ?>" target="_blank"><i class="fa fa-facebook"></i> <?php _e( 'Facebook', 'charitable-ambassadors' ) ?>
                        </a>
                    </li>
                <?php endif ?>
            </ul>
